...
const lineOpts = { responsive: true, maintainAspectRatio: false, layout: { padding: { top: 14, left: 14, right: 20 } }, interaction: { mode: 'index', intersect: false }, plugins: { legend: { labels: { color: '#5b6675', font: { size: 12 }, usePointStyle: true, pointStyle: 'circle' } }, tooltip: { mode: 'index', intersect: false }, datalabels: { color: '#97a1b0', font: { size: 10, weight: 600 }, anchor: 'end', align: 'top', offset: 2, clamp: true, formatter: v => v > 0 ? v : '' } }, scales: { x: { ticks: { color: '#97a1b0' }, grid: { color: 'rgba(120,130,150,0.12)' } }, y: { beginAtZero: true, ticks: { color: '#97a1b0', precision: 0 }, grid: { color: 'rgba(120,130,150,0.12)' } } } }
